...
export default function Header() {
    ...
    <>
        ...
        <video onLoadedData={() => setLoading(false)} className="object-cover object-center relative h-[15vh] w-full left-0 right-0 top-[-75%] -z-10" loop={true} autoPlay={true} muted={true} disablePictureInPicture controls={false} src="/videos/product.mp4"></video>
