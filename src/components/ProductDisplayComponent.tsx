...
export function ProductDisplayComponent({source, displayText, offset}: {source: string, displayText: string, offset?: number}) {
    ...
    return(
      <div className="flex flex-col p-1 rounded-2xl shadow-md hover:shadow-xl transition-all duration-200 group overflow-visible">
        ...
        <div className="mx-auto text-2xl mt-1 font-sans min-w-min overflow-visible">
          {displayText}
        </div>
      </div>
    )
